...
Para permitir upload de imagens de animais para Cloudinary, configure as seguintes variáveis de ambiente:
- `CLOUDINARY_CLOUD_NAME`
- `CLOUDINARY_API_KEY`
- `CLOUDINARY_API_SECRET`
- `CLOUDINARY_ANIMAL_FOLDER` (opcional)
- `CLOUDINARY_MAX_IMAGE_BYTES` (opcional)
...
Para instalar as migrações da base da dados, execute:
